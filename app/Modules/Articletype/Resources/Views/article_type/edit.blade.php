...
@section('content')
<div class="rows">
    <form action="{{route('article.update',['id'=>$type->id])}}" method="post" class="form-horizontal">
        @csrf
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="text" id="abbr" name="abbr" placeholder="输入缩写"
                       class="form-control @error('abbr') is-invalid @enderror" value="{{$type->abbr}}">
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="number" id="sorts" name="sorts" placeholder="输入序号"
                       class="form-control @error('sorts') is-invalid @enderror" value="{{$type->sorts}}">
