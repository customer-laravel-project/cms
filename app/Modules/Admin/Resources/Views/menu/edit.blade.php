...
@section('content')
    <div class="row">
        <div class="col-lg-12">
    <form action="{{Route("admin.menu_update",['id'=>$id])}}" method="post" class="form-horizontal">
        @csrf
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input class="form-control au-input au-input--full @error('parent_id') is-invalid @enderror" type="text" name="parent_id"
                       placeholder="父级分类"  id="parent_id" value="{{ $menu['parent_id'] }}">
                @error('name')
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input class="form-control au-input au-input--full @error('name') is-invalid @enderror" type="text" name="name"
                       placeholder="menu名称"  id="name" value="{{ $menu['name'] }}">
                @error('name')
                <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input class="form-control au-input au-input--full @error('icon') is-invalid @enderror" type="text" name="icon"
                       placeholder="icon"  id="icon" value="{{ $menu['icon'] }}">
                @error('name')
                <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input class="form-control au-input au-input--full @error('uri') is-invalid @enderror" type="text" name="uri"
                       placeholder="uri"  id="uri" value="{{ $menu['uri'] }}">
                @error('name')
                <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
